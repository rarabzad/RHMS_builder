...
Welcome to the **RHMS Builder** repository. This project provides a user-friendly interface to build, visualize, and export **RHMS basin objects**. It combines an interactive HTML GUI with R functions to manage and export basin data for modeling and analysis.

---

## Live Interface

You can explore the interactive RHMS Builder GUI directly in your browser:

[Open RHMS Builder Live](https://rarabzad.github.io/RHMS_builder/)
...
- Export basin configurations to JSON for use in R or integration with RHMS models.  
...
**Function:** [save_basin_json()](https://github.com/rarabzad/RHMS_builder/blob/main/save_basin_json)

### Description

`save_basin_json()` converts a RHMS `basin` object into a clean JSON file, handling:
...
[View example: area.json](https://github.com/rarabzad/RHMS_builder/blob/main/area.json)
...
```
RHMS_builder/
├─ rhms_builder_final.html   # Main interactive HTML GUI
...
1. Open the live GUI: [https://rarabzad.github.io/RHMS_builder/](https://rarabzad.github.io/RHMS_builder/)
